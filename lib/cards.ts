// Source of truth for all flashcards.
// Markdown is rendered with KaTeX (`$inline$` and `$$block$$`).
// Typo fixes applied vs. original docx:
...
export const episode = {
  ...
  authorNote:
    "Questions written by Dwarkesh Patel. The transcript is from the same episode.",
};
...
export const totalCardCount = sections.reduce((s, sec) => s + sec.cards.length, 0);
